          ...
          <div key={edu.id} className="grid grid-cols-1 md:grid-cols-12 gap-8 group">
            ...
            <div className="md:col-span-9 space-y-4">
              <div className="flex flex-col md:flex-row md:items-baseline md:justify-between">
                <h3 className={`text-2xl serif transition-all duration-300 ${darkMode ? 'text-white' : 'text-black'}`}>
                  {edu.degree}
                </h3>
              ...
              <p className={`text-sm leading-relaxed max-w-2xl whitespace-pre-line transition-colors ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                {edu.desc}
              </p>
            </div>
          </div>
